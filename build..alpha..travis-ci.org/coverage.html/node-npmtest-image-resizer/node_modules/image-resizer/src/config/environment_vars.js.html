...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-image-resizer/node_modules/image-resizer/src/config/environment_vars.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-image-resizer/node_modules/image-resizer/src/config/environment_vars.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-image-resizer/node_modules/image-resizer/src/config/</a> &#187; environment_vars.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (vars[key] === 'true'){
<span class="cstat-no" title="statement not covered" >      vars[key] = true;</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (vars[key] === 'false'){
<span class="cstat-no" title="statement not covered" >      vars[key] = false;</span>
    }
  }
&nbsp;
});
